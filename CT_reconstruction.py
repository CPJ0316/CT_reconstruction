...
axs[0, 2].imshow(reconstruction_3, cmap='gray')
axs[0, 2].set_title("Reconstructed Image (3°)")
...
axs[1, 2].imshow(reconstruction_03, cmap='gray')
axs[1, 2].set_title("Reconstructed Image (0.3°)")
